...
# 复合工作流工具在 macos/workflows.py（原语 vs 复合分层）。放文件末尾 import 以避免
# 与 workflows 的循环 import：本模块此时 ActionResult 已定义好，workflows 取得到。
from macos import workflows as _workflows  # noqa: E402
_HANDLERS.update(_workflows.HANDLERS)
